...
class RegistrationController {
  async store(req, res) {
    ...
    const numMonths = await Plan.findByPk(req.body.plan_id);
    ...
    const studentMail = await Student.findByPk(req.body.student_id);
  ...
  async delete(req, res) {
    const registrationDel = await Registration.findByPk(req.params.id);
